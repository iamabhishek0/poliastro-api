...
def orbit_example():
    if request.is_json:
        ...
        return jsonify(pericenter_radius=pericenter_radius, apocenter_radius=apocenter_radius, inclination=inclination, reference_frame=reference_frame, attractor=attractor, epoch=epoch)
